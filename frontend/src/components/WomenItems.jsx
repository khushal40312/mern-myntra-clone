...
export default function WomenItems({ items }) {
  ...
  // Handle adding an item to the bag with toast notification
  const handleItem = () => {
  ...
  // Handle removing an item from the bag with toast notification
